# BAMBU LAB P1S / X1 / X1C DOOR HANDLE BED SCRAPER
...
| Published URL | MakerWorld — search by Model ID `US4cd5231b94ce01` |
...
| File | Description |
|---|---|
| `DEFINITIVEHANDLESPATULA.3mf` | Bambu Studio project file (print-ready) |
