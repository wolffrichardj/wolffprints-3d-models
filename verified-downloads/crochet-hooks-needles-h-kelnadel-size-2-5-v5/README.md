# crochet hooks / needles Häkelnadel - Size 2.5 - 5
...
| Published URL | MakerWorld — search by Model ID `USd5d6c80e197d8c` |
...
| File | Description |
|---|---|
| `crochet hooks needles.3mf` | Bambu Studio project file (print-ready) |
