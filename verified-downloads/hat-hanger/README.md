...
I needed a way to store my hats in my dorm room. This is a simple model just over 50 grams that you can hang in your closet with six hats on it. Thanks for checking it out!

&nbsp;

P.S. It&#39;s great for belts too!
...
| File | Description |
|---|---|
| `hat_rack.3mf` | Bambu Studio project file (print-ready) |
