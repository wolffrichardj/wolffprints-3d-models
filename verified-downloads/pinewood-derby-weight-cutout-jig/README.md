# Pinewood Derby - Weight Cutout Jig
...
| Published URL | MakerWorld — search by Model ID `US688c1f1ad4efa` |
| License | BY-NC-ND |
...
| File | Description |
|---|---|
| `Pinewood Derby Weight Cutout Jig.3mf` | Bambu Studio project file (print-ready) |
