...
| Published URL | MakerWorld — search by Model ID `USd5ab3099dead3a` |
...
| File | Description |
|---|---|
| `Perfect+clip+v4+final+update+2.3mf` | Bambu Studio project file (print-ready) |
