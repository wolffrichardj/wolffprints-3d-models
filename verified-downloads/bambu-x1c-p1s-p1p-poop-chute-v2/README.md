# Bambu X1C P1S P1P Poop Chute V2
...
| Published URL | MakerWorld — search by Model ID `US92e78cafff6b93` |
| License | BY-NC |
...
| File | Description |
|---|---|
| `Bambu P1S Poop Chute V2.3mf` | Bambu Studio project file (print-ready) |
